...
public class payrollTest {
  ...
  void testConstructor() {
    ...
    Worker basicWorker = new Worker("Juan", "48392015S", "Casado", 2, 35000,
        12, "Indefinido", 5 , "J12345678");
  ...
  void testMonthlySalary() {
    Worker basicWorker = new Worker("Juan", "48392015S", "Casado", 2, 20000,
        12, "Indefinido", 5 , "J12345678");
    payroll = new Payroll("112025", basicWorker);
  ...
  void testSalaryExtras(){
    ...
    //assertTrue(payroll.monthlyGrossSalary(payroll.annualGrossSalary,
    // payroll.paymentsPerYear, payroll.extras) == 3666.67);
    //assertFalse(payroll.monthlyGrossSalary(payroll.annualGrossSalary,
    // payroll.paymentsPerYear, payroll.extras) == 1800);
  }
  ...
  void testSocialSecurityDeduction() {
    Worker cat1Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 1 , "J12345678");
    Worker cat4Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 4 , "J12345678");
    Worker cat2Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 2, "J12345678");
    Worker cat5Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 5, "J12345678");
    Worker cat6Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 6 , "J12345678");
    Worker cat7Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 7 , "J12345678");
    Worker cat8Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 8 , "J12345678");
    Worker cat9Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 9 , "J12345678");
    Worker cat10Worker = new Worker("Juan", "48392015S", "Soltero", 0, 10000,
        12, "Temporal", 10 , "J12345678");
  ...
  void testIrpfDeduction() {
    ...
    //Worker(String name, String dni,  String civilStatus, int children, float totalIncome, int payments,
    // String contract, int category, String cifEmpresa)
    Worker base1 = new Worker("A", "71239485K", "Soltero", 0, 12000,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 12449
    Worker base1b = new Worker("A", "71239485K", "Soltero", 0, 12449,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 12451
    Worker base1c = new Worker("A", "71239485K", "Soltero", 0, 12451,
        12, "Indefinido", 3, "J12345678");


    Worker base2 = new Worker("B", "71239485K", "Soltero", 0, 18000,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 20201
    Worker base2b = new Worker("B", "71239485K", "Soltero", 0, 20201,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 20199
    Worker base2c = new Worker("B", "71239485K", "Soltero", 0, 20199,
        12, "Indefinido", 3, "J12345678");

    Worker base3 = new Worker("C", "71239485K", "Soltero", 0, 30000,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 35199
    Worker base3b = new Worker("C", "71239485K", "Soltero", 0, 35199,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 35201
    Worker base3c = new Worker("C", "71239485K", "Soltero", 0, 35201,
        12, "Indefinido", 3, "J12345678");

    Worker base4 = new Worker("D", "71239485K", "Soltero", 0, 50000,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 59999
    Worker base4b = new Worker("D", "71239485K", "Soltero", 0, 59999,
        12, "Indefinido", 3, "J12345678");
    // Frontier value test: 60001
    Worker base4c = new Worker("D", "71239485K", "Soltero", 0, 60001,
        12, "Indefinido", 3, "J12345678");

    Worker base5 = new Worker("E", "71239485K", "Soltero", 0, 80000,
        12, "Indefinido", 3, "J12345678");
    ...
    Worker temp3 = new Worker("T3", "71239485K", "Soltero", 0, 30000,
        12, "Temporal", 3, "J12345678");
    payroll.setWorker(temp3);
    assertEquals(9900.0, payroll.calculateIrpf(), 0.01); // 33%

    Worker temp4 = new Worker("T4", "71239485K", "Soltero", 0, 50000,
        12, "Temporal", 3, "J12345678");
    payroll.setWorker(temp4);
    assertEquals(20000.0, payroll.calculateIrpf(), 0.01); // 40%

    Worker temp5 = new Worker("T5", "71239485K", "Soltero", 0, 80000,
        12, "Temporal", 3, "J12345678");
  ...
  void testCalculateNetSalary() {
    ...
    Worker w1 = new Worker("Ana", "71239485K", "Soltero", 0, 30000,
        12, "Indefinido", 5, "J12345678");
    ...
    Worker w2 = new Worker("Luis", "71239485K", "Casado", 3, 40000,
        14, "Temporal", 7, "J12345678");
    ...
    Worker w3 = new Worker("Lucia", "71239485K", "Casado", 5, 80000,
        12, "Indefinido", 10, "J12345678");
  ...
  void testCalculateMonthlyNetSalary() {
    ...
    Worker w1 = new Worker("Ana", "71239485K", "Soltero", 0, 36000,
        12, "Indefinido", 5, "J12345678");
    payroll.setWorker(w1);
    ...
    Worker w2 = new Worker("Luis", "71239485K", "Casado", 2, 42000,
        14, "Temporal", 7, "J12345678");
    payroll.setWorker(w2);
